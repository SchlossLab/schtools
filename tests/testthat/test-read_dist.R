test_that("read_dist works on example file", {
  tbl_head <- structure(list(rows = c("104_1_D1", "104_1_D10", "104_1_D10", "104_1_D2", "104_1_D2", "104_1_D2"),
  ...
  tbl_tail <- structure(list(rows = c("98_3_Dminus1", "98_3_Dminus1", "98_3_Dminus1",
