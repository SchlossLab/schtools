...
> `` `r The numbers "\u0060r paste_oxford_list(c(1e-04, 1e-05, 1e-06, 1e-07))\u0060"` `` are very precise.

Rendered output:

> `r The numbers paste_oxford_list(c(1e-04, 1e-05, 1e-06, 1e-07))` are very precise.
